...
#endif
//typedef int boolean;
static const boolean ltrue = 1;
static const boolean lfalse = 0;
...
extern boolean    solver_addclause(solver* s, lit* begin, lit* end);
extern boolean    solver_simplify(solver* s);
extern boolean    solver_solve( solver* s, lit* begin, lit* end );
