...
extern void MakeCombinations(long long n, long long k, std::vector< std::vector<long long> > &combinations, bool isOnlySizeCalc = false);
extern void MakePermutations(long long n, long long k, std::vector< std::vector<long long> > &permutations);
