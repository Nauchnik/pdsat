...
Встроено 3 SAT-решателя:
1. dminisat (вариант Беспалова minisat'a 1.14 на С)
3. minisat2 (minisat2 на С++)
3. minisat2_mod (модифицированный вариант minisat2, изменены контсанты, 
                 добавлена начальная активность ядровых переменных)
...
// убрать dminisat.h и dminisat.cpp - организовать работу с minisat 1.14 как с minisat 2.2
...
// Исправить несоответствие суммарного числа проверенных и остановленных точек числу L2.size() + L2.size() 
// Выделить прерыватель избыточных вычислений в отдельный процесс, чтобы успеть прерывать больше
// Сбор суммарной активности по всем переменным
